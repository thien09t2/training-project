...
public interface IProductDao extends JpaRepository<ProductEntity, Long> {
	...
	List<ProductEntity> resultSearch(@Param("keyword") String keywork, @Param("startPrice") double startPrice,
			@Param("endPrice") double endPrice);

	List<ProductEntity> findAllByPriceBetween(int start, int end);
}
